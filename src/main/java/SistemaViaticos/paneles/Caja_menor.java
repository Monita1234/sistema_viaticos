...
import SistemaViaticos.controlador.CtrlProgramacion;
import SistemaViaticos.controlador.CtrlReportes;
import SistemaViaticos.modelo.Registro;
import java.awt.event.ActionListener;
import java.text.SimpleDateFormat;
import java.util.Vector;
import SistemaViaticos.modelo.RegistrosTabla;
import java.io.File;
...
//        this.uno.setSelected(true);
    ...
    public void llenarTablaReporteGeneral() {
        // rellena la tabla según la información guardada en registrosTabla y lo seleccionado en el comboBox
        ...
        for (Registro registro : registrosTabla.getList()) {
            if (Integer.parseInt(String.valueOf(registro.getCuenta().charAt(0))) == listacuentas.getSelectedIndex()) {
                int ultimaFila = this.Agregar_Fila() - 1;
                this.tablaclases2.setValueAt(registro.getFecha(), ultimaFila, 1);
                this.tablaclases2.setValueAt(registro.getDetalle(), ultimaFila, 2);
                //this.tablaclases2.setValueAt(registro.getValorTotalIngresos(), ultimaFila, 3);
                //this.tablaclases2.setValueAt(registro.getValorTotalEgresos(), ultimaFila, 4);
            }
        }
    ...
    private void initComponents() {
        ...
        cmbCuenta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecionar la Cuenta:", "1. Ingresos", "2. Pasivos", "3. Patrimonio", "4. Ingresos", "5. Gastos" }));
