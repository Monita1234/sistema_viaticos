...
public class ConsultaEmpleados extends Conexion {
   ...
   //public ArrayList<Ingresos> cajamenor() throws SQLException{
       // ArrayList ingresos = new ArrayList();
        //Ingresos cajamenor;
        //PreparedStatement ps = null;
        //ResultSet rs = null;
        //String sql = "fecha, detalle, valor ingreso";
        //try {
    ...
    public boolean registroCaja_menor(CajaMenor cajamenor){
        PreparedStatement ps = null;
        String sql = "INSERT INTO cajamenor(Codigo_Cuenta, Codigo_Subcuenta, Codigo_Talonario, Fecha, Persona_Servicio, "
                + "Detalle, Cantidad, Valor_Unitario, Valor_Total) "               
                + "VALUES(?,?,?,?,?,?,?,?,?)";
        try {
            ps = con.prepareStatement(sql);
            ps.setString(1, cajamenor.getCodigo_Cuenta());
            ps.setString(2, cajamenor.getCodigo_Subcuenta());            
            ps.setString(3, cajamenor.getCodigo_Talonario());            
            ps.setString(4, cajamenor.getFecha());
            ps.setString(5, cajamenor.getPersona_Servicio());
            ps.setString(6, cajamenor.getDetalle());
            ps.setInt(7, cajamenor.getCantidad());
            ps.setDouble(8, cajamenor.getValor_Unitario());
            ps.setDouble(9, cajamenor.getValor_Total());
            ps.execute();
            return true;
